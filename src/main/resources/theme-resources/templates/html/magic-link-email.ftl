                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style="padding: 38px 30px 10px 30px; color: #333333;">
                                ...
                                <p style="margin: 0; font-size: 13px; line-height: 1.6; color: #666666;">Questions? Call <a href="tel:01582969656" style="color: #0a9c8a; text-decoration: none;">01582 969656</a> or email <a href="mailto:support@regtransfers.co.uk" style="color: #0a9c8a; text-decoration: none;">support@regtransfers.co.uk</a>.</p>
                            </td>
                        </tr>
                    </tbody>
                </table>
