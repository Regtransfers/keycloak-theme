...
export const templateName = "TOTP Removed";
...
const Content = (_props: TemplateProps) => (
    <tr>
        <td style={cs.outerTd}>
            <h1 style={cs.h1}>Authenticator app removed</h1>
            <p style={cs.p}>
                The authenticator app (TOTP) was removed from your {exp("realmName")} account.
            </p>
...
export const getSubject: GetSubject = async () => {
    return "Authenticator app removed from your account";
};
