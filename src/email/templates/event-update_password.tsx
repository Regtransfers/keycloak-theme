...
export const templateName = "Password Updated";
...
const Content = (_props: TemplateProps) => (
    <tr>
        <td style={cs.outerTd}>
            <h1 style={cs.h1}>Password changed</h1>
            <p style={cs.p}>
                The password on your {exp("realmName")} account was recently changed.
            </p>
            ...
            <p style={cs.muted}>
                ...
                activity, please reset your password and contact support immediately.
            </p>
        </td>
    </tr>
);
