...
export const templateName = "Credential Updated";
...
const Content = (_props: TemplateProps) => (
    <tr>
        <td style={cs.outerTd}>
            <h1 style={cs.h1}>Credential updated</h1>
            <p style={cs.p}>
                A credential on your {exp("realmName")} account was updated.
            </p>
...
export const getSubject: GetSubject = async () => {
    return "Your account credential was updated";
};
