...
// Hash: 3c4b2fc91a1fb87edf8f06d5fced85d37c1bd11fa72c123d6d6511838dada8f8
...
export type ThemeName = "keycloak-theme" | "keycloak-theme-dark";
    ...
    <Suspense fallback={fallback}>
      {(() => {
        switch (kcContext.themeType) {
          case "login":
            return <KcLoginPage kcContext={kcContext as import("./login/KcContext").KcContext} />;
          case "account":
            return <KcAccountPage kcContext={kcContext as import("./account/KcContext").KcContext} />;
        }
      })()}
    </Suspense>
  );
